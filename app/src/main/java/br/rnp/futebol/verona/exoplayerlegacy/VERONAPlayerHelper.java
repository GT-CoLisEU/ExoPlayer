 ...
 */
public final class VERONAPlayerHelper implements Runnable, ExoPlayer.EventListener {
    ...
    private float stallsDuration = 0;

    /**
     * @param player   The {@link SimpleExoPlayer} from which debug information should be obtained.
     * @param textView The {@link TextView} that should be updated to display the information.
     */
    public VERONAPlayerHelper(SimpleExoPlayer player, TextView textView, TExperiment experiment, Context ctx, int index, int loop, String userInfo) {
        this.player = player;
...
//            stallAux = player.getStalls();
            ...
            if (isPstFilled) {
                if (stallAux != playbackState) {
                    isFrozen = 0;
                    stallsDuration += bufferingEndAux - bufferingStartAux;
                }
            } else {
...
//        builder.setNegativeButton("Cancel", null);
    ...
    private String getStallsString() {
        String text = "\nFreezes: " + stalls;
        text += "\nFreezes Duration: " + stallsDuration + "ms";
